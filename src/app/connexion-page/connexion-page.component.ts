      ...
      this.client
        ...
        .subscribe((resultat:any) => {
          if (resultat.erreur) {
            ...
            this.hrAssociate  = this.tokenIdentification.user.value.rights.includes('HR');
            if (this.hrAssociate) {this.router.navigateByUrl("dashboard-hr-associate");}
            else {this.router.navigateByUrl("no-access");}
          }
        })
